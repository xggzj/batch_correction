...
save(dat.combat, dat.harmony, dat.limma, dat.saucie, 
     kBET.combat, kBET.harmony, kBET.limma, kBET.saucie,
     pc20.combat, pc20.harmony, pc20.limma, pc20.saucie,
     tsne.combat, tsne.harmony, tsne.limma, tsne.saucie, tsne.dat,
     umap.combat, umap.harmony, umap.limma, umap.saucie, umap.dat,
     ARI.combat, ARI.harmony, ARI.limma, ARI.saucie,
     ASW.combat, ASW.harmony, ASW.limma, ASW.saucie,
     lisi.combat, lisi.harmony, lisi.limma, lisi.saucie,
     file = "batch_test.RData")
